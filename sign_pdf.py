...
def run():
    ...
    try:
        ...
        dct = {
            ...
            'location': 'Salvador',
            'signingdate': datef,
            #'signingdate': '20210630072800-03\'00\'',
            'reason': 'Signed by Siscart',
            'signature': signature,
